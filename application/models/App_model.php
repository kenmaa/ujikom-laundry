...
class App_model extends CI_Model
{
	...
	public function MprosesTambahMember($nm_member, $tlp_member, $alamat_member,$jk_member, $id_user)
	{
	...
	public function MprosesEditMember($nm_member, $tlp_member, $alamat_member,$jk_member, $id)
	{
		$this->db->where('id_member', $id);
	...
	public function MTampilPembayaranOwner()
	{
		$this->db->order_by('status_pembayaran', 'DeSC');
		return $this->db
		->select('tb_member.*, tb_transaksi.*')
